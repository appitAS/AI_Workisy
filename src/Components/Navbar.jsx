...
function GlobeIcon(props) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M15 15H22.5V16.5H15V15ZM15 18H19.5V19.5H15V18Z" fill="currentColor" />
      <path
...
export default function Navbar() {
  ...
  // User data
  const userData = Cookies.get("user_data") ? JSON.parse(Cookies.get("user_data")) : "";
  ...
  return (
    <>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span>Services</span>
                  <svg className={`w-4 h-4 transition-transform duration-300 ${servicesMenuOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="px-4 py-2">
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="font-medium">AI Resume Matching</span>
                        </div>
                      </button>
                      <button
                        onClick={() => {
              ...
              {auth_token ? (
                <div className="relative">
                  ...
                  <Avatar
                      ...
                      style={{
                        backgroundColor: !userData?.profile_img?.trim() ? randomColor : "transparent",
                      border: "1px solid #e0e0e0",
                    }}
                    src={userData?.profile_img}
                    >
                      {(!userData.profile_img || userData.profile_img.trim() === "") && userData.name
      ...
      >
        <Box
          className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-md mx-4 transform transition-all duration-300 scale-100"
                sx={{
