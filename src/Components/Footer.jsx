...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    services: [
      { name: "AI Job Search", href: "/jobs" },
      { name: "Resume Upload", href: "/upload-resume" },
    //   { name: "Career Consulting", href: "/consulting" },
      { name: "FAQ", href: "/faq" },
    ],
    legal: [
  ...
  const socialLinks = [
    {
      name: "Facebook",
      href: "https://www.facebook.com/WorkisyPvtLtd",
      icon: (
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/workisy/posts/?feedView=all",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
